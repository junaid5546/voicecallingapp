 ...
 * @public
 */
export declare type CapabilitiesChangedReason = 'RoleChanged' | 'UserPolicyChanged' | 'MeetingOptionOrOrganizerPolicyChanged';
 ...
 * @public
 */
export declare type CapabilityResolutionReason = 'Capable' | 'CapabilityNotApplicableForTheCallType' | 'ClientRestricted' | 'UserPolicyRestricted' | 'RoleRestricted' | 'FeatureNotSupported' | 'MeetingRestricted' | 'NotInitialized' | 'NotCapable';
...
/**
 * @public
 * Captions Type for classifying Captions object type
 */
...
/**
 * @public
 * Union used to classify the finality of the current phrase's transcription.
...
/** Ability to start live captions
* @beta
*/
'startLiveCaptions' | 
/** Ability to stop live captions
* @beta
*/
'stopLiveCaptions' | 
...
export declare interface TeamsMeetingAudioConferencingDetails {
    ...
    /**
     * List of phonenumbers assigned to the teams
...
declare type VideoStreamKind = 'LocalVideoStream' | 'RemoteVideoStream' | 'LiveVideoStream' | 'ComposedVideoStream';
